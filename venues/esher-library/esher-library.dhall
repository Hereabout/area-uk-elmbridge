...
in 
  ...
  , image = Some ./Esher-Library.jpg as Location
  , boundaries =
    [ { longitude = -0.3636515421994324
      , latitude = 51.36947107250434
      }
    , { longitude = -0.3633538213191634
      , latitude = 51.36960680534112
      }
    , { longitude = -0.3636149711168402
      , latitude = 51.36976821758608
      }
    , { longitude = -0.3638591738113661
      , latitude = 51.36961239485699
      }
    , { longitude = -0.3636515421994324
      , latitude = 51.36947107250434
      }
